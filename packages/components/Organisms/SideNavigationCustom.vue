...
import './SideNavigationCustom.scss'
...
export default Vue.extend({
  ...
  computed: {
    items(): Item[] {
      return [
        {
          title: '○ 新型コロナウイルス関連サイト',
          link: ''
        },
        {
          title: '内閣官房新型コロナウイルス感染症対策推進室',
          link: 'https://corona.go.jp/'
        },
        {
        ...
        {
          title: '新型コロナウイルスに関するQ&A（一般の方向け）',
          link:
            'https://www.mhlw.go.jp/stf/seisakunitsuite/bunya/kenkou_iryou/dengue_fever_qa_00001.html'
        },
        {
          title: 'Googleニュース | コロナウイルス',
          link:
            'https://news.google.com/topics/CAAqBwgKMKjalwsw2oOvAw?hl=ja&gl=JP&ceid=JP:ja',
          divider: true
        },
        {
          title: '○ 世界の状況',
        ...
        {
          title: '新型コロナウイルス感染症（COVID-19）マップ',
          link: 'https://google.com/covid19-map/?hl=ja'
        },
        {
